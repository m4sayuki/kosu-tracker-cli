...
def require_positive_interval(interval_seconds: int, label: str = "interval") -> None:
...
def monitor_loop(interval_seconds: int) -> None:
    require_positive_interval(interval_seconds)
    ensure_dirs()
...
def report_day(target_date: date, with_ai: bool, model: str, interval_minutes: int) -> None:
    require_positive_interval(interval_minutes, label="interval minutes")
